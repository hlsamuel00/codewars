...
const scoreOfDive = (scores, tariff) => (scores.sort((el,el2) => el - el2).slice(2,-2).reduce((acc,el) => acc + el) * tariff).toFixed(2)

//*****I was able to get this kata fairly easily. I've been breaking the problem down and modifying up. 
